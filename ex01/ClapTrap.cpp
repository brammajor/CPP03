...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/01 15:24:09 by brmajor           #+#    #+#             */
/*   Updated: 2024/02/02 12:46:44 by brmajor          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string input): Name(input)
{
    ...
    this->EP = 10;
    this->AD = 0;
    std::cout << "ClapTrap was created. You named him " << this->Name << "." << std::endl;
}
